...
export default function About() {
    const [check, setstate] = useState('Enable Dark Mode');
    ...
    return (
        <>
            ...
            <div className="container">
                <button className="btn btn-outline-primary mx-2 my-3" onClick={changeTheme} >{buttonState}</button>
                <div className="form-check form-switch">
                    <input className="form-check-input" onClick={changeTheme} type="checkbox" role="switch" id="flexSwitchCheckDefault" />
                    <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{check}</label>
                </div>
